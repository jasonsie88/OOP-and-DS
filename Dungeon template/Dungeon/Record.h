...
{
private:
    void savePlayer(Player*, std::ofstream&);
    void saveRooms(vector<Room>&, std::ofstream&);
    void loadPlayer(Player*, std::ifstream&);
    void loadRooms(Player*,vector<Room>&, std::ifstream&);
